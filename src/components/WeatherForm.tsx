  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-3">
        ...
        <div className="col-span-1">
          <h3 className="text-sm font-medium text-black dark:text-white leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
            Country
          </h3>
          <select
            name="country"
            ...
            className="mt-1 md:mt-3 flex h-10 w-full border-none bg-gray-50 dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-sm  file:border-0 file:bg-transparent 
